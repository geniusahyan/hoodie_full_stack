...
<body class="flex  h-[100vh] bg-[#252234] text-white justify-center flex-col items-center" >
    ...
    <div class="wrapper flex w-[95vw] h-[90vh] rounded ">
        ...
        <div class=" wrapper_right pl-6 rounded-xl flex flex-col items-center justify-center w-[50%] h-full  bg-[] "></div>
        ...
        <div class="wrapper_left pl-6 flex flex-col items-center justify-center w-[50%] h-full  bg-[]">
            <div class="container border p-4 rounded w-[70%] h-[80%]  flex flex-col justify-around ">
                ...
                <div class="slogan ml-3 ">
                    <h2 class="text-3xl" >Create a new Account</h2>
                    <p>welcome to our hoodie site</p>
                </div>
                ...
                <div class="form_box">
                    <form action="Sign_up.php" method="post" >
                        ...
                        <div class="password my-3 relative">
                            <input required placeholder="Enter a Password" class="block px-8 m-1 w-[90%] h-9 rounded  border-b-2 bg-[#ffffff12] border-[red]" type="password" name="password" id="passinput">
                        ...
                        <div class="password my-3 relative">
                            <input required placeholder="Confirm your Password" class="block px-8 m-1 w-[90%] h-9 rounded  border-b-2 bg-[#ffffff12] border-[red]" type="password" name="comform_password" id="passinput2">
                       
                        <svg id="passview" class="w-[1.4rem] bg-[white] rounded-full h-[1.4rem] absolute top-[0.4rem] right-12 " height="1em" viewBox="0 0 640 512"><path d="M38.8 5.1C28.4-3.1 13.3-1.2 5.1 9.2S-1.2 34.7 9.2 42.9l592 464c10.4 8.2 25.5 6.3 33.7-4.1s6.3-25.5-4.1-33.7L525.6 386.7c39.6-40.6 66.4-86.1 79.9-118.4c3.3-7.9 3.3-16.7 0-24.6c-14.9-35.7-46.2-87.7-93-131.1C465.5 68.8 400.8 32 320 32c-68.2 0-125 26.3-169.3 60.8L38.8 5.1zm151 118.3C226 97.7 269.5 80 320 80c65.2 0 118.8 29.6 159.9 67.7C518.4 183.5 545 226 558.6 256c-12.6 28-36.6 66.8-70.9 100.9l-53.8-42.2c9.1-17.6 14.2-37.5 14.2-58.7c0-70.7-57.3-128-128-128c-32.2 0-61.7 11.9-84.2 31.5l-46.1-36.1zM394.9 284.2l-81.5-63.9c4.2-8.5 6.6-18.2 6.6-28.3c0-5.5-.7-10.9-2-16c.7 0 1.3 0 2 0c44.2 0 80 35.8 80 80c0 9.9-1.8 19.4-5.1 28.2zm9.4 130.3C378.8 425.4 350.7 432 320 432c-65.2 0-118.8-29.6-159.9-67.7C121.6 328.5 95 286 81.4 256c8.3-18.4 21.5-41.5 39.4-64.8L83.1 161.5C60.3 191.2 44 220.8 34.5 243.7c-3.3 7.9-3.3 16.7 0 24.6c14.9 35.7 46.2 87.7 93 131.1C174.5 443.2 239.2 480 320 480c47.8 0 89.9-12.9 126.2-32.5l-41.9-33zM192 256c0 70.7 57.3 128 128 128c13.3 0 26.1-2 38.2-5.8L302 334c-23.5-5.4-43.1-21.2-53.7-42.3l-56.1-44.2c-.2 2.8-.3 5.6-.3 8.5z"/></svg>

                        <svg class="w-[1.4rem] h-[1.4rem] absolute top-[0.4rem] left-2 " height="1em" viewBox="0 0 448 512"><path d="M144 144v48H304V144c0-44.2-35.8-80-80-80s-80 35.8-80 80zM80 192V144C80 64.5 144.5 0 224 0s144 64.5 144 144v48h16c35.3 0 64 28.7 64 64V448c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V256c0-35.3 28.7-64 64-64H80z"/></svg>
                        </div>
                        

                        <button type="submit" class="btn_btn block w-[70%] bg-[#1f1] text-[blue] m-auto my-4 ">Create</button>
    
                        <span class="text-center block" >already have an account <a class="text-blue-600" href="login.php">Login</a></span>
                    </form>
                </div>
            </div>
    ...
    <script>
            ...
            const password2 = document.getElementById('passinput2');
